...
const Students = props => {
    ...
    const [newFio, setNewFio] = useState(props.students.fio)
    const [newLogin, setNewLogin] = useState(props.students.login)
    const [newEmail, setNewEmail] = useState(props.students.email)
    const [newMobileNumber, setNewMobileNumber] = useState(props.students.mobileNumber)
                                    ...
                                    <div className='buttons'>
                                        {
                                            updateId.some(id => id === item._id)
                                                ? <a className='edit' onClick={() => {
                                                    ...
                                                    props.updateStudent(item._id, newFio, newLogin, newEmail, newMobileNumber)
                                                }} href="#s">
